...
export function EyeOffIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L3 3m3.59 3.59l10.68 10.68" />
    </svg>
  );
}
...
export function RiskIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
    </svg>
...
export function ZoneIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function CapacityIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function RelocationIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function RiskBadge({ level, className = '' }: { level: string; className?: string }) {
  ...
  return (
    <span className={`px-2 py-0.5 text-xs font-medium rounded-full ${colors[level] || 'bg-surface-500'} text-white ${className}`}>
      {level}
    </span>
  );
}

export function CapacityBadge({ status, className = '' }: { status: string; className?: string }) {
  const colors: Record<string, { bg: string; text: string }> = {
    ADEQUATE: { bg: 'bg-green-50', text: 'text-green-700' },
    LIMITED: { bg: 'bg-blue-50', text: 'text-blue-700' },
    STRESSED: { bg: 'bg-amber-50', text: 'text-amber-700' },
    INSUFFICIENT: { bg: 'bg-red-50', text: 'text-red-700' },
  };
  const color = colors[status] || { bg: 'bg-surface-50', text: 'text-surface-700' };
  return (
    <span className={`px-2 py-1 text-sm font-medium rounded-full ${color.bg} ${color.text} ${className}`}>
      {status}
    </span>
  );
}
...
export function UtilizationBar({ 
  ...
  return (
    <div className={`${height} bg-surface-200 rounded-full overflow-hidden ${className}`}>
      <div
        className={`h-full rounded-full ${getColor(utilization)} transition-all duration-500`}
